...
<body class="clinic_version">
				...
				<div class="right-header">
					<div class="header-info">
						<div class="info-inner">
							<span class="icontop"><img src="images/phone-icon.png"
						...
						<div class="info-inner">
							<span class="icontop"><i class="fa fa-envelope"
								...
								data-scroll href="mailto:info@yoursite.com">Yash.p@kp.org</a></span>
						</div>
						<div class="info-inner">
				...
				<nav class="main-menu">
					...
					<div id="navbar" class="navbar-collapse collapse">
						<ul class="nav navbar-nav">
							...
							<li><a data-scroll href="#service">Make Appointment</a></li>
							<li><a data-scroll href="#getservice">View Appointment</a></li>
	...
	<div id="about" class="section wow fadeIn">
		<div class="container">
			<div class="heading">
				<span class="icon-logo"><img src="images/icon-logo.png"
					alt="#"></span>
			...
			<div class="row">
				...
				<div class="col-md-6">
					<div class="post-media wow fadeIn">
						...
						<a href="https://www.youtube.com/watch?v=j2990o0chaU"
						...
						<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
							<div class="serv">
								<span class="icon-service"><img
									src="images/service-icon1.png" alt="#" /></span>
							...
							<form:form action="/processForm" modelAttribute="patient" method="post">
								<fieldset>
									<div
										...
										<div class="row">
											<div class="form-group">
												<form:input type="text" path="mediacalNumber"
									...
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										...
										<div class="row">
											<div class="form-group">
												<form:input path="lastName" type="text" id="name"
										...
										<div class="row">
											<div class="form-group">
												<form:input path="email" type="email"
													placeholder="Email Address" id="email" required="email" />
											</div>
										</div>
									</div>
									<div
										...
										<div class="row">
											<div class="form-group">
												<form:select class="form-control" path="doctor">
													<form:option value="Dr.Patel" label="Dr.Patel" />
													<form:option value="Dr.Sai" label="Dr.Sai" />
													<form:option value="Dr.Shah" label="Dr.Shah" />
												</form:select>
											</div>
										</div>
									</div>
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										<div class="row">
											<div class="form-group">
												<div>
													<form:textarea path="message" rows="4"
														id="textarea_message" class="form-control"
	...
	<!-- end section -->
	<div id="getservice" class="services wow fadeIn">
		<div class="container">
			
				<div class="col-lg-4">
					<div>
						<h3>
							<span></span> Find Appointment
						</h3>
						<div class="form">


							<form:form action="/getpatient" modelAttribute="patient" method="get">
								<fieldset>
									<div
										class="col-lg-12 col-md-12 col-sm-12 col-xs-12 select-section">
										<div class="row">
											<div class="form-group">
												<form:input type="text" placeholder="Medical ID" path="mediacalNumber"/>
											</div>
			...
			<div class="row dev-list text-center">
				<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 wow fadeIn"
					...
					<div class="widget clearfix">
						<img src="images/doctor_01.jpg" alt=""
				...
				<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 wow fadeIn"
					...
					<div class="widget clearfix">
						<img src="images/doctor_02.jpg" alt=""
							class="img-responsive img-rounded">
						<div class="widget-title">
							<h3>Bryan Saftler</h3>
				...
				<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 wow fadeIn">
					<div class="widget clearfix">
						<img src="images/doctor_03.jpg" alt=""
							class="img-responsive img-rounded">
						<div class="widget-title">
	...
	<div id="price" class="section pr wow fadeIn"
		style="background-image: url('images/price-bg.png');">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
	...
	<div id="testimonials" class="section wb wow fadeIn">
		<div class="container">
			...
			<!-- end title -->
			<div class="row">
				<div class="col-md-6 col-sm-12 wow fadeIn" data-wow-duration="1s"
					data-wow-delay="0.2s">
				...
				<div class="col-md-6 col-sm-12 wow fadeIn" data-wow-duration="1s"
					...
					<div class="testimonial clearfix">
						<div class="desc">
							<h3>
								<i class="fa fa-quote-left"></i> Thanks for Help us!
							</h3>
							<p class="lead">They have got my project on time with the
								competition with a sed highly skilled, and experienced &
								professional team.</p>
						...
						<div class="testi-meta">
							<img src="images/testi_02.png" alt=""
								class="img-responsive alignleft">
							<h4>
								Andrew Atkinson <small>- Life Manager</small>
							</h4>
						</div>
						<!-- end testi-meta -->
					</div>
					...
					<div class="testimonial clearfix">
						...
						<div class="testi-meta">
							<img src="images/testi_03.png" alt=""
								class="img-responsive alignleft">
							<h4>
								Amanda DOE <small>- Manager of Racer</small>
							</h4>
						</div>
						<!-- end testi-meta -->
					</div>
					...
					<div class="testimonial clearfix">
						...
						<div class="testi-meta">
							<img src="images/testi_01.png" alt=""
								class="img-responsive alignleft">
							<h4>
								Martin Johnson <small>- Founder of Goosilo</small>
							</h4>
						</div>
						<!-- end testi-meta -->
					</div>
